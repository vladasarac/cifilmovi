var Template = function(){
  ...
  // kad se klikne dugme pretrazi u formi
  $('body').on('click', '#pretrazi', function(e){    
	...
	$.post(url, postData, function(o){// salji get AJAX u kontroler cifilmovi2/film/jqsve
	  ...
	  output += '<div class="hovertabele">Pronadjeno Filmova: <strong>'+brfilmova+'</strong><br>';//pronadjeno filmova
  ...
  //kad se klikne button #unesi za unos filma u bazu
  ...
  // kad se klikne na link Prepravi
  ...
  //kad se klikne link za Cancel prepravke (tj link klase .prepravkacancel) u div-u za prepravke
  ...
  //kad se submituje forma za prepravku filma 
  ...
  //kad se klikne button za brisanje filma (#obrisifilmbutton) 
